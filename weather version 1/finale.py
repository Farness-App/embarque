...
if user_choice in drones:
    ...
    mission_time = mission.calculate_mission_time(total_distance * 1000)  # Conversion en mètres
    ...
    try:
        ...
        battery = battery_state.get('percent', 0)
        print(f"Niveau de batterie du drone : {battery}%")
    ...
    print(f"Temps estimé pour la mission: {mission_time} (HH:MM:SS)")
