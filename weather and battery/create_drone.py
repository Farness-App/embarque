...
class Drone:
    def __init__(self, name, max_wind_speed, max_clouds, min_temperature, max_temperature, max_humidity, max_flight_time, rain_sensitive=True):
        self.name = name
        ...
        self.max_flight_time = max_flight_time  # en minutes ou autre unité
    ...
    for drone_info in config["new_drones"]:
        ...
        if name in all_drones_data:
            ...
            new_drone = Drone(
                ...
                max_flight_time=drone_info["max_flight_time"],
